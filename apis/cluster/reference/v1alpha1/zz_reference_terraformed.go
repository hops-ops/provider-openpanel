...
func (tr *Reference) GetObservation() (map[string]any, error) {
...
func (tr *Reference) SetObservation(obs map[string]any) error {
...
func (tr *Reference) GetParameters() (map[string]any, error) {
...
func (tr *Reference) SetParameters(params map[string]any) error {
...
// GetInitParameters of this Reference
func (tr *Reference) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this Reference
func (tr *Reference) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
