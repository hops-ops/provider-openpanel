...
// Package clients provides the OpenPanel API client used by managed resource controllers.
package clients
...
const (
	...
	errUnmarshalCredentials = "cannot unmarshal openpanel credentials as JSON"
)
